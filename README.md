...
Navigate to **http://localhost:8000** - search for any city and enjoy! 🎉
...
Ctrl+click the printed link, or open **http://localhost:8000** manually.
...
**Port already in use**
Something else is already listening on port 8000. Either stop that process, or change `PORT=8000` to a different value (e.g. `PORT=5050`) in `.env`, save, and restart.
